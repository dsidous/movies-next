...
import { serializeMoviesBrowseSearchParams } from '@/lib/movies-discover-search-params';
...
function hrefForPage(state: MoviesBrowseSearchState, page: number): string {
...
export function MoviesPagination({ state, totalPages, totalResults, className }: MoviesPaginationProps) {
  ...
  return (
    ...
    >
      <p className="text-sm text-muted-foreground">
        ...
        <span className="tabular-nums">{totalResults.toLocaleString()}</span> titles
      </p>
