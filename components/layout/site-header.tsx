...
export function SiteHeader({ className }: { className?: string }) {
  ...
  const { open: searchOpen, setOpen: setSearchOpen, overlayKey } = useSearchShortcut();

  return (
    <>
      <SearchOverlay open={searchOpen} onOpenChange={setSearchOpen} overlayKey={overlayKey} />
      <header
        className={cn(
